...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "653e7820-2ac6-4b30-a511-9a7e2738e346",
...
const _dfbTlfu9byhR_XkH56fpSUsUOragEhjMh5GWhw0TK0 = async (_nitroApp) => {
  const config = useRuntimeConfig();
  try {
...
const _K2xP5TP73d0hHmIrYOG5hF1LHqqwtISSO3E8ErcK1g = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _dfbTlfu9byhR_XkH56fpSUsUOragEhjMh5GWhw0TK0,
_K2xP5TP73d0hHmIrYOG5hF1LHqqwtISSO3E8ErcK1g
];

const SECRET_KEY = process.env.SECRET_KEY || "secret";
const _SpFLOA = defineEventHandler(async (event) => {
...
const _hdGLzW = defineEventHandler(async (e) => {
...
const __CAdpp = defineEventHandler(async (e) => {
...
const _KXPur0 = defineEventHandler(async (e) => {
...
const _wGK1Q_ = lazyEventHandler(() => {
...
const _lazy_YHbfuG = () => import('../routes/api/admin/contactinfo.mjs').then(function (n) { return n.c; });
const _lazy_ckbfSH = () => import('../routes/api/admin/delete-file.mjs');
const _lazy_5xmfdC = () => import('../routes/api/admin/faqs.mjs');
const _lazy_y32wlC = () => import('../routes/api/admin/pricing.mjs');
const _lazy_WMcJt9 = () => import('../routes/api/admin/referral.mjs');
const _lazy_rhHSCH = () => import('../routes/api/admin/testimonial.mjs');
const _lazy_trldeC = () => import('../routes/api/auth/admin.mjs');
const _lazy_zYR04W = () => import('../routes/api/auth/authenticate.mjs');
const _lazy_CCExDg = () => import('../routes/api/blogs.mjs');
const _lazy_HvRZPZ = () => import('../routes/api/consultations/_id_.mjs');
const _lazy_rcyiSw = () => import('../routes/api/index.mjs');
const _lazy_Uk5jke = () => import('../routes/api/contactInfo.mjs');
const _lazy_qzhc0R = () => import('../routes/api/pricing.mjs');
const _lazy_WlEreW = () => import('../routes/api/referral.mjs');
const _lazy_g4UL56 = () => import('../routes/api/submittion.mjs');
const _lazy_8De10A = () => import('../routes/api/testimonial.mjs');
const _lazy_t_BqBQ = () => import('../routes/api/zoom.get.mjs');
const _lazy_hLAc6w = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _SpFLOA, lazy: false, middleware: true, method: undefined },
  { route: '/api/admin/contactinfo', handler: _lazy_YHbfuG, lazy: true, middleware: false, method: undefined },
  { route: '/api/admin/delete-file', handler: _lazy_ckbfSH, lazy: true, middleware: false, method: undefined },
  { route: '/api/admin/faqs', handler: _lazy_5xmfdC, lazy: true, middleware: false, method: undefined },
  { route: '/api/admin/pricing', handler: _lazy_y32wlC, lazy: true, middleware: false, method: undefined },
  { route: '/api/admin/referral', handler: _lazy_WMcJt9, lazy: true, middleware: false, method: undefined },
  { route: '/api/admin/testimonial', handler: _lazy_rhHSCH, lazy: true, middleware: false, method: undefined },
  { route: '/api/auth/admin', handler: _lazy_trldeC, lazy: true, middleware: false, method: undefined },
  { route: '/api/auth/authenticate', handler: _lazy_zYR04W, lazy: true, middleware: false, method: undefined },
  { route: '/api/blogs', handler: _lazy_CCExDg, lazy: true, middleware: false, method: undefined },
  { route: '/api/consultations/:id', handler: _lazy_HvRZPZ, lazy: true, middleware: false, method: undefined },
  { route: '/api/consultations', handler: _lazy_rcyiSw, lazy: true, middleware: false, method: undefined },
  { route: '/api/contactInfo', handler: _lazy_Uk5jke, lazy: true, middleware: false, method: undefined },
  { route: '/api/pricing', handler: _lazy_qzhc0R, lazy: true, middleware: false, method: undefined },
  { route: '/api/referral', handler: _lazy_WlEreW, lazy: true, middleware: false, method: undefined },
  { route: '/api/submittion', handler: _lazy_g4UL56, lazy: true, middleware: false, method: undefined },
  { route: '/api/testimonial', handler: _lazy_8De10A, lazy: true, middleware: false, method: undefined },
  { route: '/api/zoom', handler: _lazy_t_BqBQ, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_hLAc6w, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _hdGLzW, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: __CAdpp, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _KXPur0, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _wGK1Q_, lazy: false, middleware: false, method: undefined },
  { route: '/', handler: _lazy_hLAc6w, lazy: true, middleware: false, method: undefined },
  { route: '/about', handler: _lazy_hLAc6w, lazy: true, middleware: false, method: undefined },
  { route: '/contact', handler: _lazy_hLAc6w, lazy: true, middleware: false, method: undefined },
  { route: '/privacy-policy', handler: _lazy_hLAc6w, lazy: true, middleware: false, method: undefined },
  { route: '/terms-of-service', handler: _lazy_hLAc6w, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_hLAc6w, lazy: true, middleware: false, method: undefined }
];
...
export { sanitizeStatusCode as A, isScriptProtocol as B, executeAsync as C, destr as D, klona as E, getRequestHeader as F, isEqual as G, getCookie as H, deleteCookie as I, normalizeCookieHeader as J, joinHeaders as K, getRouteRulesForPath as L, getAdminEmailTemplate as a, sendEmail as b, createError$1 as c, defineEventHandler as d, withoutTrailingSlash as e, publicAssetsURL as f, getQuery as g, hasProtocol as h, buildAssetsURL as i, joinURL as j, getResponseStatusText as k, getResponseStatus as l, defineRenderHandler as m, getRouteRules as n, useNitroApp as o, parseQuery as p, createHooks as q, readBody as r, setCookie as s, getContext as t, useRuntimeConfig as u, toRouteMatcher as v, withTrailingSlash as w, createRouter$1 as x, defu as y, withQuery as z };
