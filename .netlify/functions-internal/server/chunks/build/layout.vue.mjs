import { a as _imports_0, _ as __nuxt_component_0$1 } from './logo-light.png.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link.mjs';
import { ref, withAsyncContext, mergeProps, useSSRContext, defineComponent, withCtx, createTextVNode, createVNode, toDisplayString } from 'vue';
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderComponent, ssrRenderStyle, ssrRenderList, ssrRenderClass, ssrRenderSlot } from 'vue/server-renderer';
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-9d7cc27e"]]);
...
const _sfc_main$1 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="text-center text-white text-sm"><p>© power 2025 - All Rights Reserved</p></div></div></footer>`);
    };
  }
};
