...
import { _ as _sfc_main$4 } from './ConsultationModal.vue.mjs';
import { ref, withAsyncContext, mergeProps, useSSRContext, withCtx, createVNode } from 'vue';
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent, ssrRenderStyle, ssrRenderList, ssrInterpolate, ssrRenderTeleport } from 'vue/server-renderer';
import { u as useContact } from './useContact.mjs';
import { u as useTestimonial } from './useTestimonial.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper.mjs';
import { _ as _sfc_main$5 } from './Faq.vue.mjs';
import './server.mjs';
import '../_/nitro.mjs';
...
import './useSubmittions.mjs';
import './useFaq.mjs';

const _imports_0 = "" + __buildAssetsURL("heroimage.DeidXxDo.png");
...
const _sfc_main$3 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ConsultationModal = _sfc_main$4;
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!info.value.podcastVideo) {
        ...
        _push(`</div><div class="py-4 bg-white"><p class="text-[#2E3E5C]"></p><h3 class="font-semibold text-lg">Get to know us and our passion</h3><p class="text-[#2E3E5C]"> Check out our latest podcast about A plus! Discover how personalized learning can help students excel. 🎧📚 </p></div></div>`);
      }
