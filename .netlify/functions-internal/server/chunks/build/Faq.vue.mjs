import { ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref, withAsyncContext, mergeProps, useSSRContext } from 'vue';
...
import { u as useFaq } from './useFaq.mjs';
