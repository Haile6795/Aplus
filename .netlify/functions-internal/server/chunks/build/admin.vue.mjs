import { _ as __nuxt_component_0, a as _imports_0 } from './logo-light.png.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link.mjs';
import { ref, computed, withCtx, createVNode, resolveDynamicComponent, createBlock, createTextVNode, openBlock, toDisplayString, unref, withModifiers, Transition, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrRenderVNode, ssrInterpolate, ssrRenderClass, ssrRenderSlot } from 'vue/server-renderer';
import { Menu, MenuButton, MenuItems, MenuItem } from '@headlessui/vue';
import { CurrencyDollarIcon, UsersIcon, CursorArrowRaysIcon, AtSymbolIcon, UserGroupIcon, InformationCircleIcon, ChevronDownIcon } from '@heroicons/vue/24/outline';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="min-h-screen bg-gray-50 flex"><div class="fixed inset-y-0 left-0 w-64 bg-white border-r border-gray-200"><div class="flex items-center h-16 px-6 border-b border-gray-200"><a href="/"><img${ssrRenderAttr("src", _imports_0)} alt="A plus Tutoring" class="h-12 m-auto"></a></div><nav class="p-4 space-y-1"><!--[-->`);
