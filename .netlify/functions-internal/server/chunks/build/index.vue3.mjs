...
import { ref, mergeProps, withCtx, unref, createVNode, withModifiers, withDirectives, vModelText, vModelSelect, createBlock, openBlock, Fragment, renderList, createTextVNode, vModelCheckbox, toDisplayString, useSSRContext } from 'vue';
...
import { u as usePricing } from './usePricing.mjs';
import 'vue-router';
import '../_/nitro.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const { updatePlan, isLoading } = usePricing();
    ref([]);
    ref("");
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(isLoading)) {
              ...
              _push2(`<span${_scopeId}>${ssrInterpolate(selectedPlan.value ? "Update Plan" : "Create Plan")}</span>`);
            }
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "flex justify-end space-x-4" }, [
                      ...
                      createVNode("button", {
                        ...
                        unref(isLoading) ? (openBlock(), createBlock("span", { key: 0 }, "Saving...")) : (openBlock(), createBlock("span", { key: 1 }, toDisplayString(selectedPlan.value ? "Update Plan" : "Create Plan"), 1))
                      ], 8, ["disabled"])
                    ])
                  ], 32)
                ])
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/pricing/[id]/index.vue");
