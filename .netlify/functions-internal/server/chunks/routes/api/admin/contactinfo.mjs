import { o as useNitroApp, J as normalizeCookieHeader, K as joinHeaders, L as getRouteRulesForPath } from '../../../_/nitro.mjs';
...
const contactinfo = /*#__PURE__*/Object.freeze({
  __proto__: null
});

export { contactinfo as c, handler as h };
